...
class PageExt extends Main{
    ...
    function __construct(){
        ...
        if(count($page) > 0){
            ...
            $modules = $this->q('SELECT pm.* FROM ext_page_module AS pm INNER JOIN modules AS m ON pm.module_id = m.id WHERE page_id = :pageid AND active = 1 ORDER BY position_id ASC','ASSOC',$pageid);
